...
> Small CSS & HTML experiments and snippets

**59 demos** · 🔗 **[Live gallery](https://fadyehabamer.github.io/css-snippets/)** — every demo is deployed to GitHub Pages.
...
| [`Iphone6s-LockUnlock`](./Iphone6s-LockUnlock/) | Lock & Unlock iPhone 6s | [🔗 Live](https://fadyehabamer.github.io/css-snippets/Iphone6s-LockUnlock/) |
| [`JS-DataAttributes`](./JS-DataAttributes/) | Change styling using (custom attributes) with javascript | [🔗 Live](https://fadyehabamer.github.io/css-snippets/JS-DataAttributes/) |
| [`KeyCodes-App`](./KeyCodes-App/) | get keycodes live while pressing keyboard | [🔗 Live](https://fadyehabamer.github.io/css-snippets/KeyCodes-App/) |
| [`LEON`](./LEON/) | Leon "Minimal website" | [🔗 Live](https://fadyehabamer.github.io/css-snippets/LEON/) |
| [`LightDark-modeSwitch-customAtrributes`](./LightDark-modeSwitch-customAtrributes/) | Dark / Light mode Switch ( data attributes technique ) | [🔗 Live](https://fadyehabamer.github.io/css-snippets/LightDark-modeSwitch-customAtrributes/) |
| [`LoopLap`](./LoopLap/) | LoopLap bootstrap theme | [🔗 Live](https://fadyehabamer.github.io/css-snippets/LoopLap/) |
...
| [`Password-Generator`](./Password-Generator/) | Complex 16-char password Generator with JS | [🔗 Live](https://fadyehabamer.github.io/css-snippets/Password-Generator/) |
...
| [`VanillaBootsrapFilter`](./VanillaBootsrapFilter/) | Filter Images using only Bootstrap | [🔗 Live](https://fadyehabamer.github.io/css-snippets/VanillaBootsrapFilter/) |
| [`Vex-Smartwatch-Theme`](./Vex-Smartwatch-Theme/) | Vex-theme: Smartwatch Bootstrap 5 Theme from themefisher | [🔗 Live](https://fadyehabamer.github.io/css-snippets/Vex-Smartwatch-Theme/) |
| [`WeightConverter`](./WeightConverter/) | Live Weight Converter using JS | [🔗 Live](https://fadyehabamer.github.io/css-snippets/WeightConverter/) |
| [`Xaxis-ScrollBarIndicator`](./Xaxis-ScrollBarIndicator/) | X-axis scrollbar indicator using javascript | [🔗 Live](https://fadyehabamer.github.io/css-snippets/Xaxis-ScrollBarIndicator/) |
| [`ZerOne-FE-Task`](./ZerOne-FE-Task/) | Our benifits section using Css3 & flex box & media query | [🔗 Live](https://fadyehabamer.github.io/css-snippets/ZerOne-FE-Task/) |
| [`change-browser-tab-theme`](./change-browser-tab-theme/) | change browser tab theme in mobile | [🔗 Live](https://fadyehabamer.github.io/css-snippets/change-browser-tab-theme/) |
| [`kbd-StyledTag`](./kbd-StyledTag/) | Custom style for Kbd Tag | [🔗 Live](https://fadyehabamer.github.io/css-snippets/kbd-StyledTag/) |
| [`out-of-range-selector`](./out-of-range-selector/) | out of range selector for inputs in CSS | [🔗 Live](https://fadyehabamer.github.io/css-snippets/out-of-range-selector/) |
| [`scroll-margin-block`](./scroll-margin-block/) | Asset for blog post explaining scroll-margin-block usage and what it fix | [🔗 Live](https://fadyehabamer.github.io/css-snippets/scroll-margin-block/) |
